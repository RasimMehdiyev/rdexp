    ...
    <div className="bg-sn-subheader-blue sticky top-16 shadow-md z-20"> 
      <div className="p-2 h-16 flex flex-row justify-between items-center">
        <div className='flex flex-row justify-between gap-1 items-center'>
            ...
            <p className='text-[20px] font-russoOne text-white'>Edit {eventType}</p>
        </div>
      <div className='flex flex-row justify-between gap-1'>
        <div className='flex flex-row justify-between gap-4'>       
            <button className='bg-sn-main-orange h-8 w-[72px] text-white rounded-[10px] text-[14px]' onClick={onDelete}>DELETE</button>
        </div>
        <div className='flex flex-row justify-between gap-4'>       
