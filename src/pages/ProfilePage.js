  ...
  return (
    ...
    <div className="self-stretch h-[237px] p-2 flex-col justify-start items-center gap-2 flex">
        ...
        <div className="flex-col justify-start items-center gap-1 flex">
            <div className="text-center text-blue-800 text-3xl font-['Russo_One'] leading-normal">Jeff Hugh</div>
            <div className="text-center text-neutral-900 text-sm font-['Inter_Bold'] uppercase">Coach</div>
        </div>
        <div className="self-stretch justify-center items-center gap-4 inline-flex">
            <div className="justify-center items-center gap-1 flex">
                <div className="text-center text-neutral-900 text-sm font-['Inter_Regular']">jeff.hugh@email.co</div>
            </div>
            <div className="justify-center items-center gap-1 flex">
                <div className="w-[18px] h-[18px] relative"></div>
                <div className="text-center text-black text-sm font-['Inter_Regular']">+12 345 567 89</div>
            </div>
        </div>
    </div>
    <div className="self-stretch h-[242px] px-2 py-4 flex-col justify-start items-center gap-2 flex">
        <div className="self-stretch text-center text-neutral-900 text-xl font-bold font-['Inter_Regular']">About</div>
              <div className="w-[343px] text-center text-neutral-600 text-sm font-normal font-['Inter_Regular']">
    ...
    <div className="flex-col justify-start items-center gap-2 flex">
        <div className="w-[322px] h-[33px] p-2.5 bg-orange-500 rounded justify-center items-center gap-2.5 inline-flex">
            <div className="text-white text-sm font-normal font-['Inter_Regular'] uppercase">Edit Profile</div>
        </div>
        <div className="w-[322px] h-[33px] p-2.5 bg-zinc-300 rounded justify-center items-center gap-2.5 inline-flex">
            <div className="text-neutral-900 text-sm font-normal font-['Inter_Regular'] uppercase">Sign out</div>
        </div>
    </div>
      </div>
    </div>
